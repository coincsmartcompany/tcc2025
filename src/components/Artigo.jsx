    ...
    <div className="bg-[#F5F0E1] min-h-screen w-full px-4 pt-6 relative">
      ...
      <div className="md:hidden">
        ...
        <div className="pt-32 pb-10 px-6">
          ...
          <h1 className="text-2xl font-bold text-center text-[#1a2e45] mb-17 whitespace-nowrap">ARTIGOS CIENTÍFICOS</h1>
      ...
      <div className="hidden md:block bg-[#F5F0E1] min-h-screen">
        ...
        <div className="ml-[380px] mr-10 py-10">
          <h1 className="text-4xl font-bold text-center text-[#1a2e45] mb-24 mt-12">ARTIGOS CIENTÍFICOS</h1>
