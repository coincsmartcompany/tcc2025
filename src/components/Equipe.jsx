      ...
      <div className="md:hidden">
        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-20 pt-36 px-6 justify-center">
          {membros.map((membro, i) => (
            ...
            >
              <div
                className="absolute -top-[50px] rounded-full border-4 border-[#EC5C8F] shadow-lg flex justify-center items-center"
                style={{
                  width: '110px',
                  height: '110px',
              ...
              <div
                className="text-center font-nunito font-bold mt-[60px] whitespace-pre-line"
                style={{
                  width: `${membro.nomeW}px`,
                  height: `${membro.nomeH}px`,
                  fontSize: '20px',
                }}
              >
                {membro.nome}
              ...
              <div
                ...
                style={{
                  width: `${membro.cargoW}px`,
                  height: `${membro.cargoH}px`,
                  fontSize: '12px',
                }}
              >
                {membro.cargo}
      ...
      <div className="hidden md:block bg-[#F5F0E1] min-h-screen">
        <div className="fixed left-0 top-0 w-[350px] h-full bg-[#1A2E45] z-10 flex flex-col items-center pt-12">
          <img
            src={Logo2}
            alt="Logo"
            className="w-48 h-12 mb-6 cursor-pointer"
            onClick={() => navigate('/')}
          />
          ...
          <div className="w-full px-8 space-y-8">
            ...
            <div
              className="flex items-center gap-4 cursor-pointer py-3 bg-[#2a4365] rounded-lg px-4 transition-colors"
              onClick={() => navigate('/equipe')}
            >
        ...
        <div className="ml-[380px] py-10 px-10">
          ...
          <div className="flex justify-center gap-8">
            {membros.map((membro, i) => (
              ...
              >
                <div
                  className="absolute -top-16 rounded-full border-6 border-[#EC5C8F] overflow-hidden bg-white flex justify-center items-center"
                  style={{
                    width: '170px',
                    height: '170px',
                  }}
