        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-20 pt-36 px-6 justify-center">
          {membros.map((membro, i) => (
            <div key={i} className="bg-white rounded-md shadow-md relative flex flex-col items-center" style={{ width: '174px', height: '295px' }}>
              ...
              <div className="absolute -top-[50px] rounded-full border-4 border-[#EC5C8F] shadow-lg flex justify-center items-center" style={{ width: '100px', height: '100px', backgroundColor: '#ffffff', boxShadow: '0 4px 6px rgba(0,0,0,0.25)' }}>
              ...
              <div className="text-center font-nunito font-normal mt-2" style={{ width: '155px', height: '56px', fontSize: '10px' }}>
