    ...
    <div className="min-h-screen w-full relative">
      ...
      <div className="md:hidden">
        ...
        <div className="w-full bg-[#72B8C3] flex flex-col items-center pt-20 pb-16">
          ...
          {/* Container para a imagem final com o quadrado personalizado atrás */}
          ...
          <div className="w-[320px] px-4 mt-4 mb-8">
            <p className="text-[16px] font-nunito font-bold text-[#F5F0E1] text-center leading-tight whitespace-pre-line">
              {`Ideal para crianças de 6 a 10 anos, o jogo ensina de forma lúdica a guardar, planejar e conquistar sonhos, transformando educação financeira em uma aventura cheia de desafios и recompensas. Corra com Coiny, evite armadilhas do consumo e mostre que você é um verdadeiro economista mirim!`}
            </p>
          </div>
