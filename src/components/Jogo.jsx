    ...
    <div className="min-h-screen w-full relative">
      ...
      <div className="md:hidden">
        ...
        >
          ...
          {/* Conteúdo dentro do background - SUBIDO */}
          <div className="pt-[400px] pb-10 px-6"> {/* subido de 600px para 400px */}
        ...
        <div className="w-full h-[500px] bg-[#72B8C3] flex justify-center items-start pt-20">
          <div className="w-[300px] h-[200px] bg-gray-400 rounded-lg shadow-md"></div>
        </div>
      </div>

      {/* DESKTOP */}
      <div
        className="hidden md:block bg-cover bg-center min-h-screen"
