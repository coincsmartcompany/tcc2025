...
const ArtigoDark = () => {
  ...
  const navigateToArtigo = () => {
    navigate('/artigo');
  };

  return (
    <div className="bg-[#0B1523] min-h-screen w-full px-4 pt-6 relative">
     
      <div className="md:hidden">
        <div className="absolute top-[21px] left-[25px]">
          <img src={Logo1} alt="Logo" className="w-[123px] h-[30px] cursor-pointer" onClick={() => navigate('/dark')} />
        </div>
        ...
        {menuOpen && (
          ...
          >
            <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/passosdark')}>
              <img src={Passo} alt="Passo" className="w-[15px] h-[15px]" />
              <span className="text-white text-sm">Passo a passo</span>
            </div>

            <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/produtosdark')}>
              <img src={Informacao} alt="Produtos" className="w-[15px] h-[15px]" />
              <span className="text-white text-sm">Produtos</span>
            </div>

            <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/equipedark')}>
              <img src={Grupo} alt="Equipe" className="w-[15px] h-[15px]" />
              <span className="text-white text-sm">Equipe</span>
            </div>

            <div className="flex itemsCenter gap-2 cursor-pointer" onClick={() => navigate('/artigodark')}>
              <img src={Artigo} alt="Artigo" className="w-[15px] h-[15px]" />
              <span className="text-white text-sm">Artigo</span>
            </div>

            <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/jogodark')}>
        ...
        <div className="pt-32 pb-10 px-6">
          ...
          <h1 className="text-2xl font-bold text-center text-white mb-17 whitespace-nowrap">ARTIGOS CIENTÍFICOS</h1>
          ...
          <div className="space-y-32">
            ...
            <div className="relative mx-auto" style={{ width: '257px', height: '422px' }}>
              ...
              <div className="bg-transparent border-4 border-[#EC5C8F] rounded-[20px] p-6 h-full flex flex-col justify-center pt-8">
                <h3 className="text-base font-bold text-white mb-4 text-center leading-tight mt-2">A IMPORTÂNCIA DA EDUCAÇÃO FINANCEIRA INFANTIL</h3>
                <ul className="list-disc list-inside text-white space-y-2 pl-4 text-sm mt-2">
            ...
            <div className="relative mx-auto" style={{ width: '257px', height: '422px' }}>
              ...
              <div className="bg-transparent border-4 border-[#EC5C8F] rounded-[20px] p-6 h-full flex flex-col justify-center pt-8">
                <h3 className="text-base font-bold text-white mb-4 text-center leading-tight mt-2">EDUCAÇÃO FINANCEIRA COMO PRÁTICA PEDAGÓGICA</h3>
                <ul className="list-disc list-inside text-white space-y-2 pl-4 text-sm mt-2">
            ...
            <div className="relative mx-auto" style={{ width: '257px', height: '422px' }}>
              ...
              <div className="bg-transparent border-4 border-[#EC5C8F] rounded-[20px] p-6 h-full flex flex-col justify-center pt-8">
                <h3 className="text-base font-bold text-white mb-4 text-center leading-tight mt-2">EDUCAÇÃO FINANCEIRA INFANTIL</h3>
                <ul className="list-disc list-inside text-white space-y-2 pl-4 text-sm mt-2">
            ...
            <div className="relative mx-auto" style={{ width: '257px', height: '422px' }}>
              ...
              <div className="bg-transparent border-4 border-[#EC5C8F] rounded-[20px] p-6 h-full flex flex-col justify-center pt-10">
                <h3 className="text-base font-bold text-white mb-4 text-center leading-tight mt-4">A IMPORTÂNCIA DA EDUCAÇÃO FINANCEIRA</h3>
                <ul className="list-disc list-inside text-white space-y-2 pl-4 text-sm mt-4">
      ...
      <div className="hidden md:block bg-[#0B1523] min-h-screen">
        <div className="fixed left-0 top-0 w-[350px] h-full bg-[#1A2E45] z-10 flex flex-col items-center pt-12">
          <img src={Logo} alt="Logo" className="w-48 h-12 mb-8 cursor-pointer" onClick={() => navigate('/dark')}/>

          <div className="w-80 h-px bg-white opacity-30 mb-8"></div>
          
          <div className="w-full mt-12 px-8 space-y-8">
            <div className="flex items-center gap-4 cursor-pointer py-3 hover:bg-[#2a4365] rounded-lg px-4 transition-colors" onClick={() => navigate('/passosdark')}>
              <img src={Passo} alt="Passo" className="w-6 h-6" />
              <span className="text-white text-lg font-medium">Passo a passo</span>
            </div>

            <div className="flex items-center gap-4 cursor-pointer py-3 hover:bg-[#2a4365] rounded-lg px-4 transition-colors" onClick={() => navigate('/produtosdark')}>
              <img src={Informacao} alt="Produtos" className="w-6 h-6" />
              <span className="text-white text-lg font-medium">Produtos</span>
            </div>

            <div className="flex items-center gap-4 cursor-pointer py-3 hover:bg-[#2a4365] rounded-lg px-4 transition-colors" onClick={() => navigate('/equipedark')}>
              <img src={Grupo} alt="Equipe" className="w-6 h-6" />
              <span className="text-white text-lg font-medium">Equipe</span>
            </div>

            <div className="flex items-center gap-4 cursor-pointer py-3 bg-[#EC5C8F] rounded-lg px-4 transition-colors" onClick={() => navigate('/artigodark')}>
        ...
        <div className="ml-[380px] mr-10 py-10">
          <h1 className="text-4xl font-bold text-center text-white mb-24 mt-12">ARTIGOS CIENTÍFICOS</h1>
          ...
          <div className="flex justify-center gap-8 max-w-6xl mx-auto">
            ...
            <div className="relative" style={{ width: '280px', height: '422px' }}>
              ...
              <div className="bg-transparent border-4 border-[#EC5C8F] rounded-[20px] p-6 h-full flex flex-col justify-center">
                <h3 className="text-lg font-bold text-white mb-4 text-center">A IMPORTÂNCIA DA EDUCAÇÃO FINANCEIRA INFANTIL</h3>
                <ul className="list-disc list-inside text-white space-y-2 pl-4 text-sm">
            ...
            <div className="relative" style={{ width: '280px', height: '422px' }}>
              ...
              <div className="bg-transparent border-4 border-[#EC5C8F] rounded-[20px] p-6 h-full flex flex-col justify-center">
                <h3 className="text-lg font-bold text-white mb-4 text-center">EDUCAÇÃO FINANCEIRA COMO PRÁTICA PEDAGÓGICA</h3>
                <ul className="list-disc list-inside text-white space-y-2 pl-4 text-sm">
            ...
            <div className="relative" style={{ width: '280px', height: '422px' }}>
              ...
              <div className="bg-transparent border-4 border-[#EC5C8F] rounded-[20px] p-6 h-full flex flex-col justify-center">
                <h3 className="text-lg font-bold text-white mb-4 text-center">EDUCAÇÃO FINANCEIRA INFANTIL</h3>
                <ul className="list-disc list-inside text-white space-y-2 pl-4 text-sm">
                  <li>A educação financeira infantil é importante para orientar as crianças a gerenciar dinheiro de forma correta, desenvolvendo hábitos financeiros desde cedo.</li>
                  <li>O artigo explica os desafios de implementar esse ensino nas escolas e as estratégias para torná-lo mais eficaz e acessível às crianças.</li>
                </ul>
            ...
            <div className="relative" style={{ width: '280px', height: '422px' }}>
              ...
              <div className="bg-transparent border-4 border-[#EC5C8F] rounded-[20px] p-6 h-full flex flex-col justify-center">
                <h3 className="text-lg font-bold text-white mb-4 text-center">A IMPORTÂNCIA DA EDUCAÇÃO FINANCEIRA</h3>
                <ul className="list-disc list-inside text-white space-y-2 pl-4 text-sm">
                  <li>O artigo destaca a importância da educação financeira para o desenvolvimento de habilidades que ajudam a tomar decisões conscientes e com responsabilidade.</li>
