    ...
    <div className="bg-[#0B1523] min-h-screen w-full relative">
      ...
      <div className="md:hidden">
        <div className="flex justify-between items-center px-6 py-5 absolute top-0 left-0 w-full z-50">
          <img src={Logo} alt="Logo" className="w-[123px] h-[30px] cursor-pointer" onClick={() => navigate('/dark')} />
        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-20 pt-36 px-6 justify-center">
          {membros.map((membro, i) => (
            <div key={i} className="bg-[#1A2E45] rounded-md shadow-md relative flex flex-col items-center" style={{ width: '174px', height: '295px' }}>
            
              <div className="absolute -top-[50px] rounded-full border-4 border-[#EC5C8F] shadow-lg flex justify-center items-center" style={{ width: '100px', height: '100px', backgroundColor: '#0B1523', boxShadow: '0 4px 6px rgba(0,0,0,0.25)' }}>
                <img src={membro.img} alt="Membro" className="w-[75px] h-[75px] rounded-full" />
              </div>

              <div className="text-center font-nunito font-bold mt-[60px] whitespace-pre-line text-white" style={{ width: `${membro.nomeW}px`, height: `${membro.nomeH}px`, fontSize: '20px' }}>
                {membro.nome}
              </div>
              ...
              <div className="text-center font-nunito font-normal mt-2 text-white" style={{ width: '155px', height: '56px', fontSize: '10px' }}>
      ...
      <div className="hidden md:block bg-[#0B1523] min-h-screen">
        ...
        <div className="fixed left-0 top-0 w-[350px] h-full bg-[#1A2E45] z-10 flex flex-col items-center pt-12">
          ...
          <div className="w-full px-8 space-y-8">
            ...
            <div className="flex itemsCenter gap-4 cursor-pointer py-3 bg-[#2a4365] rounded-lg px-4 transition-colors" onClick={() => navigate('/equipe')}>
        ...
        <div className="ml-[380px] py-10 px-10">
          ...
          <div className="text-left mb-32 mt-16 flex items-start"> 
            ...
            <div>
              <h1 className="text-white text-4xl font-bold mb-4">NOSSA EQUIPE</h1>
              <p className="text-white text-xl">Conheça os membros da nossa equipe</p>
            </div>
          </div>
          
          <div className="flex justify-center gap-8">
            {membros.map((membro, i) => (
              <div key={i} className="bg-[#1A2E45] shadow-lg rounded-lg p-6 flex flex-col items-center relative" style={{ width: '250px', height: '437px', flexShrink: 0 }}>
                
                <div className="absolute -top-16 rounded-full border-6 border-[#EC5C8F] overflow-hidden bg-[#0B1523] flex justify-center items-center" style={{ width: '150px', height: '150px' }}>
                ...
                <div className="mt-28 text-center flex flex-col justify-between h-full">
                  <div>
                    <h2 className="text-white text-xl font-bold mb-3 whitespace-pre-line">{membro.nome}</h2>
