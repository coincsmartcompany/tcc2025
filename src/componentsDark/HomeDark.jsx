...
const HomeDark = () => {
  ...
  return (
    <div className="relative bg-[#0B1523] w-full min-h-screen">
      
      <div className="md:hidden bg-[#0B1523]">
        ...
        <div className="mt-6 px-4 relative">
          ...
          <button onClick={() => navigate('/passosdark')}
        ...
        <div className="mt-12 px-6 text-center">
          <h2 className="text-[#F5F0E1] text-2xl font-bold mb-4">Diferencial do Projeto</h2>
          <p className="text-[#F5F0E1] text-sm">
        ...
        <div className="mt-12 bg-[#EC5C8F] rounded-xl p-6 text-center">
          <h2 className="text-[#F5F0E1] text-2xl font-bold mb-4">Público alvo</h2>
          <p className="text-[#F5F0E1] text-sm mb-6 max-w-xs mx-auto">
        ...
        <div className="mt-12 px-6 text-center">
          <h2 className="text-[#F5F0E1] text-2xl font-bold mb-4">Objetivo</h2>
          <p className="text-[#F5F0E1] text-sm max-w-xs mx-auto">
        ...
        <div className="mt-12 bg-[#1a2e45] rounded-t-xl w-full p-6 pb-36 text-center">
          <h2 className="text-[#F5F0E1] text-2xl font-bold mb-4">Tudo bem, é<br />SmartCoinc!</h2>
          <p className="text-[#F5F0E1] text-lg mb-6">As crianças amam. As famílias confiam.</p>

          <div className="mt-6 mx-4 bg-[#0B1523] rounded-lg p-4 text-center">
          ...
          <button className="w-full max-w-xs h-16 bg-[#0B1523] rounded-2xl text-[#1CB0F6] font-bold text-lg border border-[#1CB0F6]">
            NOSSA EQUIPE
          </button>
        </div>
        </div>
      ...
      <div className="hidden md:block bg-[#0B1523] min-h-screen">
        ...
        <div className="flex justify-between items-center px-12 py-6 bg-[#0B1523]">
          <img src={Logo} alt="Logo" className="w-40 h-10 cursor-pointer" />
          
          <div className="flex items-center gap-8">
            <nav className="flex gap-8">
              <span className="text-[#F5F0E1] cursor-pointer hover:text-[#EC5C8F] transition-colors font-semibold">Início</span>
              <span className="text-[#F5F0E1] cursor-pointer hover:text-[#EC5C8F] transition-colors font-semibold" onClick={() => navigate('/produtos')}>Produtos</span>
              <span className="text-[#F5F0E1] cursor-pointer hover:text-[#EC5C8F] transition-colors font-semibold" onClick={() => navigate('/artigos')}>Artigos</span>
              <span className="text-[#F5F0E1] cursor-pointer hover:text-[#EC5C8F] transition-colors font-semibold" onClick={() => navigate('/equipe')}>Equipe</span>
              <span className="text-[#F5F0E1] cursor-pointer hover:text-[#EC5C8F] transition-colors font-semibold" onClick={() => navigate('/jogos')}>Jogos</span>
            </nav>
        ...
        <div className="bg-[#0B1523] py-20 px-12">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-[#F5F0E1] text-4xl font-bold text-center mb-16">
              Diferencial do Projeto
            </h2>
            
            <div className="grid grid-cols-2 gap-12 items-center">
              <div>
                <p className="text-[#F5F0E1] text-lg leading-relaxed">
                  Une design lúdico com funcionalidades educativas, como desafios semanais and feedbacks personalizados, 
                  promovendo o engajamento contínuo da criança no aprendizado financeiro de maneira prática e atrativa.
                </p>
              </div>
        ...
        <div className="bg-[#1a2e45] rounded-t-3xl py-12 px-8 mx-auto max-w-4xl"> 
          <div className="text-center">
            <h2 className="text-[#F5F0E1] text-3xl font-bold mb-4"> 
              Tudo bem, é<br />SmartCoinc!
            </h2>
            <p className="text-[#F5F0E1] text-xl mb-6"> 
              As crianças amam. As famílias confiam.
            </p>

            <div className="bg-[#0B1523] rounded-2xl p-6 max-w-md mx-auto mb-6">
              <img src={Certificado} alt="Certificado" className="w-40 h-14 mx-auto mb-3" />
              <p className="text-[#F5F0E1] text-sm">
                O programa kidSAFE Seal certifica a segurança de sites, aplicativos e produtos interativos voltados para crianças, garantindo que atendam a padrões independentes de segurança infantil.
              </p>
            ...
            <div className="flex justify-center gap-4">
              ...
              <button className="px-8 py-2 bg-[#0B1523] rounded-2xl text-[#1CB0F6] font-bold text-lg border-2 border-[#1CB0F6] hover:bg-[#1a2e45] transition-colors">
                NOSSA EQUIPE
              </button>
            </div>
          </div>
