        ...
        <div className="pt-28 pb-10 px-6">
          <div className="mb-20">
            ...
            <div className="text-center mx-4 mt-8">
              ...
              <h4 className="text-white text-base mb-3">Ligue seu porquinho!</h4>
              <p className="text-white text-[12px] font-normal max-w-[280px] mx-auto">
          ...
          <div className="mb-20">
            ...
            <div className="text-center mx-4 mt-8">
              ...
              <h4 className="text-white text-base mb-3">Conecte e cadastra-se</h4>
              <p className="text-white text-[12px] font-normal max-w-[280px] mx-auto">
          ...
          <div className="mb-20">
            ...
            <div className="text-center mx-4 mt-8">
              ...
              <h4 className="text-white text-base mb-3">Deposite seu dinheiro</h4>
              <p className="text-white text-[12px] font-normal max-w-[280px] mx-auto">
          ...
          <div className="mb-20">
            ...
            <div className="text-center mx-4 mt-8">
              ...
              <h4 className="text-white text-base mb-3">Quer retirar o dinheiro?</h4>
              <p className="text-white text-[12px] font-normal max-w-[280px] mx-auto">
          ...
          <div className="mt-12 mb-8 flex justify-center">
            <div className="w-[320px] h-[180px] bg-gray-600 rounded-lg flex items-center justify-center">
      ...
      <div className="hidden md:block bg-[#0B1523] min-h-screen">
        ...
        <div className="ml-[380px] mr-10 py-10">
          <div className="space-y-40 max-w-6xl mx-auto">
            ...
            <div className="flex gap-16 items-center">
              ...
              <div className="max-w-md text-center">
                ...
                <h4 className="text-white text-2xl mb-6">Ligue seu porquinho!</h4>
            ...
            <div className="flex gap-16 items-center flex-row-reverse">
              ...
              <div className="max-w-md text-center">
                ...
                <h4 className="text-white text-2xl mb-6">Conecte e cadastra-se</h4>
                <p className="text-white text-xl leading-relaxed">
                  Ative o Bluetooth do seu celular, conecte ao porquinho e faça o cadastro no aplicativo. Em poucos toques, você já pode começar a usar.
                </p>
              </div>
            ...
            <div className="flex gap-16 items-center">
              ...
              <div className="max-w-md text-center">
                ...
                <h4 className="text-white text-2xl mb-6">Deposite seu dinheiro</h4>
                <p className="text-white text-xl leading-relaxed">
                  Coloque o dinheiro na abertura superior do porquinho. Elle vai guardar tudinho com segurança!
                </p>
              </div>
            ...
            <div className="flex gap-16 items-center flex-row-reverse">
              ...
              <div className="max-w-md text-center">
                ...
                <h4 className="text-white text-2xl mb-6">Quer retirar o dinheiro?</h4>
                <p className="text-white text-xl leading-relaxed">
          ...
          <div className="mt-40 mb-20 flex justify-center">
            <div className="w-full max-w-4xl h-96 bg-gray-600 rounded-2xl flex items-center justify-center shadow-lg">
