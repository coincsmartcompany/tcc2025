...
import estrela from '../assets/estrela-light.png';
...
const ProdutosDark = () => {
  ...
  return (
    <div className="bg-[#0B1523] min-h-screen w-full relative">
     
      <div className="md:hidden">
        <div className="absolute top-[21px] left-[25px]">
          <img
            src={Logo} alt="Logo" className="w-[123px] h-[30px] cursor-pointer" onClick={() => navigate('/dark')}/>
        </div>
        ...
        <div className="absolute top-[21px] right-[25px] flex items-center gap-3 z-50">
          ...
          <img src={DarkMode} alt="Light Mode" className="w-[33px] h-[33px] cursor-pointer" onClick={handleLightModeClick}/>
        </div>
        ...
        {menuOpen && (
          <div
            ...
            <div
              className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/passosdark')} >
              <img src={passos} alt="Passos" className="w-[15px] h-[15px]" /><span className="text-white text-sm">Passo a passo</span>
            </div>
            <div
              className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/produtosdark')} >
        ...
        <div className="relative">
          ...
          <h1
            className="absolute top-6 left-1/2 -translate-x-1/2 text-white font-bold" style={{ fontFamily: 'Nunito', fontSize: '16px' }}>
            Produto
          </h1>
        </div>

        <div className="px-6 py-4">
          <p className="text-white font-semibold text-lg">R$ 500,00</p>
        ...
        <div className="px-6 py-4 grid grid-cols-2 sm:grid-cols-3 gap-6 mt-6">
          <div className="flex flex-col items-center">
            ...
            <p className="font-nunito font-semibold mt-2 text-white">ESP32</p>
            <p className="font-nunito font-bold mt-1 text-white">R$38,00</p>
          </div>

          <div className="flex flex-col items-center">
            <img src={displaytouch} alt="Display Touch" className="w-[150px] h-[150px] object-cover" />
            <p className="font-nunito font-semibold mt-2 text-white">Display Touch</p>
            <p className="font-nunito font-bold mt-1 text-white">R$214,90</p>
          </div>

          <div className="flex flex-col items-center">
            <img src={displayoled} alt="Display OLED" className="w-[150px] h-[150px] object-cover" />
            <p className="font-nunito font-semibold mt-2 text-white">Display OLED</p>
            <p className="font-nunito font-bold mt-1 text-white">R$28,10</p>
          </div>

          <div className="flex flex-col items-center">
            <img src={mp3} alt="Módulo MP3 DFPlayer" className="w-[150px] h-[150px] object-cover" />
            <p className="font-nunito font-semibold mt-2 text-white">Módulo MP3 DFPlayer</p>
            <p className="font-nunito font-bold mt-1 text-white">R$17,00</p>
          </div>

          <div className="flex flex-col items-center">
            <img src={altofalante} alt="Mini Alto Falante" className="w-[150px] h-[150px] object-cover" />
            <p className="font-nunito font-semibold mt-2 text-white">Mini Alto Falante</p>
            <p className="font-nunito font-bold mt-1 text-white">R$29,90</p>
          </div>

          <div className="flex flex-col items-center">
            <img src={cartao} alt="Cartão de Memória" className="w-[150px] h-[150px] object-cover" />
            <p className="font-nunito font-semibold mt-2 text-white">Cartão de Memória</p>
            <p className="font-nunito font-bold mt-1 text-white">R$15,96</p>
          </div>
        </div>
      </div>
        ...
        <div className="ml-[380px] py-10 px-10">
          ...
          <div className="flex gap-12 items-start">
            ...
            <div className="max-w-md">
              <h2 className="text-white text-3xl font-bold mb-6">Smart Coinc - Porquinho Inteligente</h2>
              <div className="flex items-center gap-1 mb-4">
                {[...Array(5)].map((_, index) => (
                  <img key={index} src={estrela} alt="Estrela" className="w-6 h-6" />
                ))}
              </div>
              <p className="text-white font-semibold text-2xl mb-6">R$ 500,00</p>
          ...
          <div className="mt-20">
            ...
            <div className="grid grid-cols-3 gap-8">
              <div className="flex flex-col items-center bg-[#1A2E45] p-6 shadow-md">
                <img src={esp32} alt="ESP32" className="w-[180px] h-[180px] object-contain mb-4" />
                <p className="font-semibold text-lg text-white mb-2">ESP32</p>
                <p className="font-bold text-lg text-white">R$38,00</p>
              </div>

              <div className="flex flex-col items-center bg-[#1A2E45] p-6 shadow-md">
                <img src={displaytouch} alt="Display Touch" className="w-[180px] h-[180px] object-contain mb-4" />
                <p className="font-semibold text-lg text-white mb-2">Display Touch</p>
                <p className="font-bold text-lg text-white">R$214,90</p>
              </div>

              <div className="flex flex-col items-center bg-[#1A2E45] p-6 shadow-md">
                <img src={displayoled} alt="Display OLED" className="w-[180px] h-[180px] object-contain mb-4" />
                <p className="font-semibold text-lg text-white mb-2">Display OLED</p>
                <p className="font-bold text-lg text-white">R$28,10</p>
              </div>

              <div className="flex flex-col items-center bg-[#1A2E45] p-6 shadow-md">
                <img src={mp3} alt="Módulo MP3 DFPlayer" className="w-[180px] h-[180px] object-contain mb-4" />
                <p className="font-semibold text-lg text-white mb-2">Módulo MP3 DFPlayer</p>
                <p className="font-bold text-lg text-white">R$17,00</p>
              </div>

              <div className="flex flex-col items-center bg-[#1A2E45] p-6 shadow-md">
                <img src={altofalante} alt="Mini Alto Falante" className="w-[180px] h-[180px] object-contain mb-4" />
                <p className="font-semibold text-lg text-white mb-2">Mini Alto Falante</p>
                <p className="font-bold text-lg text-white">R$29,90</p>
              </div>

              <div className="flex flex-col items-center bg-[#1A2E45] p-6 shadow-md">
                <img src={cartao} alt="Cartão de Memória" className="w-[180px] h-[180px] object-contain mb-4" />
                <p className="font-semibold text-lg text-white mb-2">Cartão de Memória</p>
                <p className="font-bold text-lg text-white">R$15,96</p>
              </div>
            </div>
          </div>
        </div>
